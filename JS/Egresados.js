...
$('#CartaPresentacionEgresado').on('input', function () {
    if ($(this).val().trim().length > 0) {
        ...
        Toastify({
            text: 'Recomendación: Se puntual al escribir una carta de presentación tiene que ser clara y concisa que resalte tus habilidades y experiencia relevantes para el trabajo que estás buscando.\nMUCHO EXITO Y SUERTE!!!',
            duration: 10000,
            gravity: "top",
            position: "right",
            style: {
    ...
    $.ajax({
        ...
        error: function (error) {
            ...
            swal.fire({
                title: 'Error',
                icon: 'error',
                text: 'Oops... ocurrió un error al procesar la solicitud. Intente nuevamente.'
            });
